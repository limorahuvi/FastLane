...
<div align="center">
    <h3>"""),_display_(/*47.10*/title),format.raw/*47.15*/(""" """),format.raw/*47.16*/("""Visualization
        ...
        <div id="loadingGif" style="display:none; size:1px;"><img src="https://media.giphy.com/media/3oEjI6SIIHBdRxXI40/giphy.gif" height="200" width="200"></div>
    </h3>
</div>
<div class="grid-container">
    <div class="parameters" align="left">
        """),_display_(/*54.10*/parameters),format.raw/*54.20*/("""
    """),format.raw/*55.5*/("""</div>
    <div class="map"> <div id='map'><!--<pre id='info'></pre>--></div></div>
</div>
"""),_display_(/*58.2*/calculateMap()),format.raw/*58.16*/("""
